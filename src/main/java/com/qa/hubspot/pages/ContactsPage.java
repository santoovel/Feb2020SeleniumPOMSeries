...
// to click on contacts link after creating new data and to create fresh data
	...
	/*
	 * public void createNewContact(String emailId, String firstname, String
	 * lastname,String jobtitle) {
	 ...
	 * 
	 * elementUtil.waitForElementToBePresent(contactNavigationLink, 10);
	 * elementUtil.doClick(contactNavigationLink); //contactNavigationLink
	 * 
	 * }
	 */
